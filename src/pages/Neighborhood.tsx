...
export default function Neighborhood() {
  ...
  useSEO({
    title: neighborhood
      ? `Eletricista no ${neighborhood.name} - Hortolândia | Atendimento 24 Horas`
      : "Eletricista em Hortolândia",
    description: neighborhood
      ? `Precisa de um eletricista no ${neighborhood.name}, Hortolândia? Atendimento rápido, certificado NR10 e NR35, 24 horas. ${neighborhood.description}`
      : "Eletricista profissional em Hortolândia.",
    jsonLd: neighborhood ? {
      "@context": "https://schema.org",
      "@type": "Electrician",
      "name": `Eletricista em Hortolândia - Atendimento no ${neighborhood.name}`,
      "image": "https://eletricistaemhortolandia.com.br/manus-storage/hero_eletricista_8af14beb.jpg",
      "url": `https://eletricistaemhortolandia.com.br/bairro/${neighborhood.id}`,
      ...
      "hasMap": `https://www.google.com/maps/search/eletricista+${encodeURIComponent(neighborhood.name)}+hortolandia`,
      "areaServed": {
      ...
      "description": `Eletricista profissional atendendo o bairro ${neighborhood.name} em Hortolândia, com mais de 20 anos de experiência. ${neighborhood.description}`,
    } : undefined,
  });
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-800">
        <div className="container">
          ...
          <p className="text-lg text-blue-100 mb-8 max-w-2xl">
            Serviços elétricos profissionais em {neighborhood.name}, Hortolândia. Atendimento 24 horas com técnicos certificados.
          </p>
          <a 
        ...
        <div className="container max-w-3xl">
          <div className="bg-white rounded-lg p-8 shadow-lg mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Você está em {neighborhood.name} e precisa de um eletricista? {neighborhood.description}. Estamos aqui para atender você com rapidez e profissionalismo. Nossos técnicos certificados estão disponíveis 24 horas para resolver qualquer problema elétrico em Hortolândia.
            </p>
            <p className="text-muted-foreground mb-4">
              {specialtyText}
            </p>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                <span className="text-muted-foreground">✓ Atendimento rápido em Hortolândia - Resolvemos no mesmo dia</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-lg p-8 text-center text-white">
            ...
            <p className="text-blue-100 mb-6">Chame agora! Atendimento imediato, profissional e seguro em Hortolândia.</p>
            <a 
              href={`https://api.whatsapp.com/send/?phone=5519994252525&text=Olá,%20gostaria%20de%20solicitar%20um%20orçamento%20em%20${neighborhood.name}`}
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm">{neighborhood.name}, Hortolândia - SP</p>
