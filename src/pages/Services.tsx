...
export default function Services() {
  ...
  useSEO({
    title: "Serviços Elétricos em Hortolândia - Instalação e Manutenção | Eletricista em Hortolândia",
    description: "Conheça todos os serviços elétricos que oferecemos em Hortolândia: instalações, manutenção, quadro elétrico, iluminação, reformas e atendimento emergencial 24h.",
  });
  ...
  const services = [
    ...
    },
    {
      ...
      items: [
        ...
        "Atendimento 24 horas em Hortolândia",
      ]
    },
    {
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-800">
        <div className="container text-center">
          ...
          <p className="text-lg text-blue-100 max-w-2xl mx-auto">
            Oferecemos uma ampla gama de serviços de instalação e manutenção elétrica para residências, comércios e indústrias em Hortolândia e região
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-50">
        <div className="container text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">
            Não encontrou o serviço que procura em Hortolândia?
          </h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Entre em contato conosco. Oferecemos soluções personalizadas para qualquer necessidade elétrica em Hortolândia e região.
          </p>
          <a 
            href="https://api.whatsapp.com/send/?phone=5519994252525&text=Olá,%20gostaria%20de%20solicitar%20um%20orçamento."
