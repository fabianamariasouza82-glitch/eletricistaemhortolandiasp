...
const faqs = [
  {
    question: "Quanto custa um eletricista em Hortolândia?",
  ...
  {
    question: "Vocês atendem emergências elétricas 24 horas em Hortolândia?",
  ...
  {
    question: "Quais bairros de Hortolândia vocês atendem?",
    answer: "Atendemos toda a cidade de Hortolândia, incluindo Jardim Bela Vista, Nova Veneza, Matão, Centro, Picerno e mais de 30 outros bairros. Veja a lista completa mais abaixo nesta página.",
  },
  {
  ...
  },
  {
    ...
    answer: "Para atendimentos em Hortolândia, nosso tempo médio de chegada é rápido, e priorizamos ainda mais os chamados de emergência. O prazo exato depende do seu bairro e da disponibilidade no momento do chamado.",
  },
];
...
export default function Home() {
  ...
  useSEO({
    title: "Eletricista em Hortolândia - Serviços 24 Horas | Profissional Certificado",
    description: "Eletricista profissional em Hortolândia com mais de 20 anos de experiência. Atendimento 24 horas para residências, comércios e condomínios. Certificado NR10 e NR35.",
    jsonLd: {
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container flex items-center justify-between h-40">
          <div className="flex items-center gap-2">
            <img 
              ...
              alt="Eletricista em Hortolândia" 
      ...
      <section className="relative overflow-hidden min-h-[420px] sm:min-h-[520px] md:min-h-[780px] lg:min-h-[900px]">
        <div className="absolute inset-0">
          <img 
            ...
            alt="Eletricista profissional em Hortolândia" 
        ...
        <div className="container relative py-20 md:py-40 lg:py-48">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
              Eletricista Profissional em Hortolândia
            </h1>
            <p className="text-lg text-blue-100 mb-8">
              Mais de 20 anos de experiência. Atendimento 24 horas para residências, comércios e condomínios em Hortolândia. Certificado NR10 e NR35.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-3">
              Nossos Serviços em Hortolândia
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Oferecemos soluções completas para todas as suas necessidades elétricas em Hortolândia e região
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Somos uma empresa especializada em serviços elétricos residenciais, comerciais e industriais em Hortolândia e região. Com mais de 20 anos de experiência, realizamos mais de 2.500 atendimentos com foco em segurança, agilidade e preço justo.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-accent" />
                  <span className="text-foreground">Atendimento em todos os bairros de Hortolândia</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-accent" />
      ...
      <section id="contato" className="py-20 bg-gradient-to-r from-blue-900 to-blue-800 scroll-mt-28">
        <div className="container text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Precisa de um Eletricista em Hortolândia Agora?
          </h2>
          <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
            Entre em contato conosco para um orçamento. Atendimento rápido e profissional em toda Hortolândia garantido.
          </p>
      ...
      <section className="py-20 bg-blue-50">
        <div className="container max-w-3xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Tire suas dúvidas sobre nossos serviços de eletricista em Hortolândia
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-3">
              Atendemos Todos os Bairros de Hortolândia
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Encontre informações específicas sobre nossos serviços em seu bairro em Hortolândia
            </p>
          </div>
      ...
      <footer className="bg-blue-950 text-white py-12">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-bold mb-4">Eletricista em Hortolândia</h3>
              <p className="text-blue-200 text-sm">Serviços elétricos profissionais com mais de 20 anos de experiência em Hortolândia e região.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm">Hortolândia, SP</p>
          ...
          <div className="border-t border-blue-800 pt-8 flex flex-col items-center gap-6 text-center text-blue-200 text-sm">
            ...
            <p>&copy; 2026 Eletricista em Hortolândia. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
